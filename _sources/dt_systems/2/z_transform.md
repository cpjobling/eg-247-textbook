...
| 3 | $\displaystyle{a^nu_0[n]}$ | $\displaystyle{\frac{z}{z-a}}$ | $\|z\| > a$ |
| 4 | $\displaystyle{u_0[n]}$ | $\displaystyle{\frac{z}{z-1}}$ | $\|z\| > 1$ |
| 5 | $\displaystyle{(e^{-anT_s})u_0[n]}$ | $\displaystyle{\frac{z}{z-e^{-aT_s}}}$ | $\displaystyle{\|e^{-aT_s}z^{-1}\| < 1}$ |
| 6 | $\displaystyle{(\cos naT_s)u_0[n]}$ | $\displaystyle{\frac{z^2 - z\cos aT_s}{z^2 -2z\cos aT_s + 1}}$ | ${\|z\| > 1}$ |
| 7 | $\displaystyle{(\sin naT_s)u_0[n]}$ | $\displaystyle{\frac{z\sin aT_s}{z^2 -2z\cos aT_s + 1}}$ | ${\|z\| > 1}$ |
| 8 | $\displaystyle{(a^n\cos naT_s)u_0[n]}$ | $\displaystyle{\frac{z^2 - az\cos aT_s}{z^2 -2az\cos aT_s + a^2}}$ | ${\|z\| > 1}$ |
| 9 | $\displaystyle{(a^n\sin naT_s)u_0[n]}$ | $\displaystyle{\frac{az\sin aT_s}{z^2 -2az\cos aT_s + a^2}}$ | ${\|z\| > 1}$ |
